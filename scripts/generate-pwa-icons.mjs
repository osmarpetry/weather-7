...
throw new Error(
  'PWA icon assets are missing and automatic generation is only configured for macOS with sips. Run `node scripts/generate-pwa-icons.mjs` on macOS and commit the generated files.'
)
